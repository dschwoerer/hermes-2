...
BoutReal UpdatedRadiatedPower::recombination(BoutReal n, BoutReal T) {
  ...
  const double MATA[9][9] = {
      {-28.55728479302, 0.03488563234375, -0.02799644392058, 0.01209545317879,
       -0.00243663079982, 0.00028378937198, -1.886511169084E-05,
       6.752155602894E-07, -1.005893858779E-08},
      {-0.7664042607917, -0.00358323336613, -0.00745251429279, 0.00270929976045,
       -0.00077451297662, 0.00011424446982, -9.382783518064E-06,
       3.902800099653E-07, -6.387411585521E-09},
...
BoutReal UpdatedRadiatedPower::chargeExchange(BoutReal T) {
  ...
  if (T < 0.14660) { // avoid unphysical part of function
    ...
    // double E = 10.0; // used for computing the vector from the commented
    // matrix
    ...
    const double cxcoeffs[9] = {
        -1.76861862430790530709e+01, 1.93633165585571261069e-02,
    ...
    if (lograte > logratelim) {
      lograte = logratelim;
      throw BoutException(
          "UpdatedRadiatedPower::chargeExchange limiting lograte!\n");
    }
